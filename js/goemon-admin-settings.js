...
function loadCategories() {
    try {
        ...
        if (savedCategories) {
            ...
            // デフォルトカテゴリ
            categories = [
                { id: 'mens', name: 'メンズ', slug: 'mens', description: '男性向けファッション', order: 0 },
                { id: 'ladies', name: 'レディース', slug: 'ladies', description: '女性向けファッション', order: 1 },
                { id: 'accessories', name: 'アクセサリー', slug: 'accessories', description: 'ファッション小物', order: 2 }
            ];
